...
func NewRouter(h *Handlers) http.Handler {
	...
	v1.HandleFunc("/search/bulk", h.BulkSearch).Methods(http.MethodPost)
	...
	v1.HandleFunc("/profiles", h.ListProfiles).Methods(http.MethodGet)
	v1.HandleFunc("/profiles", h.UpsertProfile).Methods(http.MethodPost)
	v1.HandleFunc("/profiles/{id}", h.UpsertProfile).Methods(http.MethodPut)
	v1.HandleFunc("/profiles/{id}", h.DeleteProfile).Methods(http.MethodDelete)

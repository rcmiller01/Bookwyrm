...
func main() {
	...
	namingTemplateEbook := envOrDefault("NAMING_TEMPLATE_EBOOK", "{Author}/{Title}/{Title} - {Author}.{Ext}")
	namingTemplateAudiobookSingle := envOrDefault("NAMING_TEMPLATE_AUDIOBOOK_SINGLE", "{Author}/{Title}/{Title} - {Author}.{Ext}")
	namingTemplateAudiobookFolder := envOrDefault("NAMING_TEMPLATE_AUDIOBOOK_FOLDER", "{Author}/{Title}")
	...
	keepIncomingRaw, keepIncomingSource := envOrDefaultWithSource("IMPORT_KEEP_INCOMING", "false")
